  ...
  describe '#body' do
    ...
    context 'with virtual objects' do
      ...
      describe 'parent object' do
        ...
        it 'generates a correct manifest' do # rubocop:disable RSpec/ExampleLength
          ...
          expect(json['thumbnail']).to eq(
            [{ 'type' => 'Image',
               'id' => 'https://stacks.stanford.edu/image/iiif/cg767mn6478%2F2542A/full/!400,400/0/default.jpg',
               'format' => 'image/jpeg',
               'service' =>
    ...
    context 'with stanford only PDF' do
      ...
      it 'generates a manifest that includes the login service for the restricted file' do
        ...
        expect(canvas['items']).to eq(
          [{ 'type' => 'AnnotationPage',
             'id' => 'http://test.host/bh502xm3351/iiif3/annotation_page/cocina-fileSet-bh502xm3351-bh502xm3351_1',
             'items' =>
             [{ 'type' => 'Annotation',
                'motivation' => 'painting',
                'id' => 'http://test.host/bh502xm3351/iiif/annotation/cocina-fileSet-bh502xm3351-bh502xm3351_1',
                'target' => 'http://test.host/bh502xm3351/iiif/canvas/cocina-fileSet-bh502xm3351-bh502xm3351_1',
                'body' =>
                { 'id' => 'https://stacks.stanford.edu/file/bh502xm3351/CAS_bh502xm3351.pdf',
                  'type' => 'Text',
                  'label' => { en: ['CAS_bh502xm3351.pdf'] },
                  'format' => 'application/pdf',
                  'service' =>
                  [{ 'id' => 'https://stacks.stanford.edu/iiif/auth/v2/probe?id=https%3A%2F%2Fstacks.stanford.edu%2Ffile%2Fbh502xm3351%2FCAS_bh502xm3351.pdf',
                     'type' => 'AuthProbeService2',
                     'errorHeading' => { 'en' => ['No access'] },
                     'errorNote' => { 'en' => ['You do not have permission to access this resource'] },
                     'service' =>
