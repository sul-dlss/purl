  ...
  describe 'Abstract/Contents' do
    context 'with an abstract' do
      ...
      it 'displays the abstract' do
        expect(page).to have_text 'We present an ice-penetrating radar dataset acquired over the Greenland ice sheet by aircraft'
      end
    end
    ...
    context 'with a note with no type, but with Abstract in the displayLabel' do
      ...
      it 'displays the abstract' do
        expect(page).to have_text 'The brain implements recognition systems with incredible competence.'
      end
    end
    ...
    context 'with contents' do
      ...
      it 'displays the contents' do
        expect(page).to have_text 'Complete scans of box 1 folder 1 of from the Robert Baxter collection.'
      end
    end
  end
end
